...
{
    // Genel veritabanı işlemleri gerçekleştirmek üzre tasarlanmış genel repository sınıfı
        ...
        where Tcontext : IdentityDbContext<AppUser, AppRole, int>, new()
    {
        ...
        public Tentity Get(Expression<Func<Tentity, bool>> filter)
        {
            using (var db = new Tcontext())
            {
                // Find(...) does not accept an expression — use FirstOrDefault/SingleOrDefault instead
